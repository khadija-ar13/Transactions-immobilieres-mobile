...
export default function ({ navigation }) {
    ...
    const fetchAnnouncementsByFilter = async (filterQuery) => {
        try {
            const response = await fetch("http://192.168.57.43:3002/annonces/filtre_Annonceur_mobile", {
                            ...
                            <View style={styles.card}>
                                ...
                                <View style={styles.container}>
                                    ...
                                    <View>
                                        ...
                                        <Text style={styles.normalText}>{item.statut}</Text>
                                    </View>
                                    <View>
                                        <Text style={styles.title}>Etat: </Text>
                                        <Text style={styles.normalText}>{item.etat}</Text>
                                    </View>
